...
class Brick(GameObject):
    ...
    def __init__(self, canvas, x, y, hits):
        ...
        self.hits = hits
        self.canvas = canvas
        self.power_up_chance = 0.2  # 20% chance for power-up
    ...
    def spawn_power_up(self):
        self.canvas.master.trigger_double_ball()
...
class Game(tk.Frame):
    ...
    def trigger_double_ball(self):
        new_balls = []
        for ball in self.balls:
            coords = ball.get_position()
            new_balls.append(Ball(self.canvas, coords[0], coords[1]))
    ...
    def remove_offscreen_balls(self):
        self.balls = [ball for ball in self.balls if ball.get_position()[3] < self.height]
